...
def state_to_representation_last(state, action_set, slot_set, disease_symptom, max_turn):
    ...
    state_rep = np.hstack((current_slots_rep,probable_grp,probable_grpP,probable_sym, user_action_rep, user_inform_slots_rep, user_request_slots_rep, agent_action_rep, agent_inform_slots_rep, agent_request_slots_rep, turn_rep))
    return state_rep
...
def reduced_state_to_representation_last(state, slot_set, parameter):
    ...
    state_rep = np.hstack([c,probable_grp,probable_grpP,probable_sym, turn_rep]).flatten()
