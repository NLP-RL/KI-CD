...
parser.add_argument("--epsilon", dest="epsilon", type=float, default=0.05, help="The greedy probability of DQN")
...
parser.add_argument("--saved_model", dest="saved_model", type=str, default="./../../model/DQN/checkpoint/1122232100_agenthrljoint2_T28_ss100_lr0.0005_RFS84_RFF0_RFNCY0_RFIRS0_RFRA-44_RFRMT-66_mls0_gamma0.95_gammaW0.9_epsilon0.05_awd0_crs0_hwg0_wc0_var0_sdai0_wfrs44_dtft0_ird0_ubc0.985_lbc1e-10_data_RID0/")

parser.add_argument("--save_dialogue", dest="save_dialogue", type=boolean_string, default=False, help="Save the dialogue? [True, False]")
parser.add_argument("--dialogue_file", dest="dialogue_file", type=str, default="dialogue_file.txt", help="the file that used to save dialogue content.")
...
#Role of check_related_symptoms
