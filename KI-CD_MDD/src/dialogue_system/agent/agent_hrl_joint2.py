...
class AgentHRL_joint2(object):
    def __init__(self, action_set, slot_set, disease_symptom, parameter):
        ...
        #for model in dirs:
            ...
            temp_parameter[label]["input_size_dqn"] = (len(slot_set)-1)*3 + 118 + 5 #28 for max turn
        ...
        if parameter.get("state_reduced"):
            input_size = (len(self.slot_set)-1) * 4 + 5   # the dictionary of slot_set contains a key of "disease" which need to be removed first.
